...
<p>Geazer SB, a cheap selfbot with almost 340 commands being nothing like the generic github copy and paste selfbots. Geazer comes with uniquely created features requested by our customers, and other never before seen features all at the power of the customers fingertips.</p>
...
<details open>
  ...
  <ul>
    ...
    <li>Great informative <a target="_blank" title="Help command screenshots" href="https://imgur.com/a/1vM2Emo">help command</a> ✓</li>
    ...
    <li>
      <b> And in total over <u>335</u> commands! ✓</b>
    </li>
  </ul>
</details>
...
<details open>
  <summary>open/close</summary>
  <ul>
    <p>These are all the default commands implemented in the bot.</p>
      ...
      <ul>
        ...
        <details>
          ...
          <ul>
            ...
            <li>All requests are async now</code></li>
